...
TEST(InstructionSetTest, GetInstructionSetFromString) {
  ...
  EXPECT_EQ(InstructionSet::kLoongarch64, GetInstructionSetFromString("loongarch64"));
...
TEST(InstructionSetTest, GetInstructionSetString) {
  ...
  EXPECT_STREQ("loongarch64", GetInstructionSetString(InstructionSet::kLoongarch64));
