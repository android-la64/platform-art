...
// LOONGARCH64 instruction alignment. This is the recommended alignment for maximum performance.
static constexpr size_t kLoongarch64Alignment = 16;
...
namespace instruction_set_details {
    ...
    !defined(ART_STACK_OVERFLOW_GAP_loongarch64)
...
#elif defined(__x86_64__) || defined(__aarch64__) || (defined(__loongarch__) && (__loongarch_grlen == 64))
