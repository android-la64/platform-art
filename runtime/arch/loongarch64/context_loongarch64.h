...
#ifndef ART_RUNTIME_ARCH_LOONGARCH64_CONTEXT_LOONGARCH64_H_
#define ART_RUNTIME_ARCH_LOONGARCH64_CONTEXT_LOONGARCH64_H_
...
class Loongarch64Context final : public Context {
 public:
  Loongarch64Context() { Reset(); }
  ...
  void SetNterpDexPC(uintptr_t /*dex_pc_ptr*/) override {
    UNREACHABLE();  // Nterp is not supported on LOONGARCH  yet
  }
...
#endif  // ART_RUNTIME_ARCH_LOONGARCH64_CONTEXT_LOONGARCH64_H_
